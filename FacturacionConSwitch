                ...
                switch (opcion)
                {
                    ...
                    case 4:
                        ...
                        while (opcion3 != 4)
                        {
                            ...
                            if (opcion3 < 4 && opcion3 >= 0)
                            {
                                Console.Write("Cantidad de producto: ");
                                string cantidad = Console.ReadLine();
                                int cant = Convert.ToInt32(cantidad);
                                if (cant > cantidades[opcion3])
                                {
                                    Console.WriteLine("No hay suficiente en inventario, la cantidad que hay es: " + cantidades[opcion3]);
                                }
                                else
                                {
                                    productosVendidos[iterador] = frutas[opcion3];
                                    cantidadesVendidas[iterador] = cant;
                                    iterador++;
                                    cantidades[opcion3] -= cant;
                                    subtotal += (cant * precios[opcion3]);
                                }
                            }
                        }
